...
# This will only work so long as the vector has the component of largest eigenvector.
# Please note the the input_matrix must be symmetric.
# Input:
...
# Configure to read and process Float.
# Use in conjunction with Scalar.
...
# Manually check that ODUSA implementation and numpy give the same answers.
# As of 10/2021 this requires a manual check because of data silo limitations.
